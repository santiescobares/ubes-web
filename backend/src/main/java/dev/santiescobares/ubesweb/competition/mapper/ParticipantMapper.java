...
public interface ParticipantMapper {
    ...
    @Mapping(source = "studentCertificateKey", target = "studentCertificateURL", qualifiedByName = "r2KeyToR2URL")
    @Mapping(source = "medicalCertificateKey", target = "medicalCertificateURL", qualifiedByName = "r2KeyToR2URL")
